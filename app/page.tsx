...
function CategoryCard({
  ...
  return (
    <Link
      href={href}
      className="group flex flex-col gap-2 rounded-lg border border-zinc-200 bg-white p-5 transition-all hover:shadow-lg hover:border-zinc-300 dark:border-zinc-700 dark:bg-zinc-800 dark:hover:border-zinc-600"
    >
